try:
    try:
        ...
        bgpath = 'gui/img-content/backgrounds/'
        bgs = listdir(bgpath)
        bgs.remove('ccbg.png')
        ...
        for x in dictvars:
            ...
            i += 1
        saveicon = PhotoImage(file='gui/img-content/icons/save.png')
        ...
        nexticon = PhotoImage(file='gui/img-content/icons/next.png')
        ...
        cvplace = PhotoImage(file='gui/img-content/icons/acplace.png')
